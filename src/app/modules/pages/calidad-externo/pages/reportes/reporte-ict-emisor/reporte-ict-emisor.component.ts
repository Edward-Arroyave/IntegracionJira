...
import { NgIf, NgFor, NgClass, LowerCasePipe, TitleCasePipe } from '@angular/common';
...
@Component({
    ...
    standalone: true,
    imports: [NgIf, FormsModule, ReactiveFormsModule, MatFormFieldModule, MatInputModule, MatDatepickerModule, MatSelectModule, MatOptionModule, NgFor, MatTooltipModule, NgClass, LowerCasePipe, TitleCasePipe, TranslateModule, ImageCdnPipe]
})
